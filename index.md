...
[**Check the Slides here:**](https://github.com/gabyrech/LongReadsQC/blob/727b243bd8bf935f111b0b3b15ae780d018917d6/LRSW2022_CompBio_Intro_web.pdf)
...
+ [**Tutorial Set Up**](#SETUP)
  ...
  + [**Data Set**](#DATA)
    + [Toy dataset](#TOYDATA)
+ [**Quick QC using SeqKit**](#SEQKIT)
+ [**Quick QC using SeqFu**](#SEQFU)
+ [**Comprehensive QC using NanoPack**](#NANOPACK)
  + [NanoPlot](#NANOPLOT)
  + [NanoComp](#NANOCOMP)
+ [**Comprehensive QC using pycoQC**](#PYCOQC)
...
## Quick QC using SeqKit <a name="SEQKIT"></a>
...
## Quick QC using SeqFu <a name="SEQFU"></a>
...
## Comprehensive QC using NanoPack <a name="NANOPACK"></a>
...
## Comprehensive QC using pycoQC <a name="PYCOQC"></a>

[**PycoQC**](https://a-slide.github.io/pycoQC/) is a data visualisation and quality control tool **exclusive** for ONT data. Its exclusivity lies in the fact that requires of the  _sequencing_summary.txt_ file generated by ONT basecallers (e.g. Guppy/Albacore).

I like PycoQC particulary for two reasons:
1. It creates really nice interactive plots (using [Ploty](https://plotly.com/)).
2. You can easily compare stats between **all** reads, **passing filter** reads and **mapped** reads. 

To make the most of pycoQC you first need to map your reads to the reference genome. 
Here I show a tipical workflow for generating full QC reports by making use of all great features in pycoQC:
...
Results:
The above commands will generate a HTML file called MyRunResults.html. This should look something like [this](https://a-slide.github.io/pycoQC/pycoQC/results/Guppy-2.3_basecall-1D_alignment-DNA.html). 
